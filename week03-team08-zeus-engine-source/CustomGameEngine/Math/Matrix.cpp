...
FMatrix FMatrix::PerspectiveMatrix(float FovDegree, float AspectRatio, float Near, float Far)
{
...
FMatrix FMatrix::OrthographicMatrix(float orthoHeight, float AspectRatio, float Near, float Far)
{
	FMatrix M = ZeroMatrix();
