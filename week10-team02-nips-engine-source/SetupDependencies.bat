...
set "FREETYPE_H=%PROJECT_ROOT%\vcpkg_installed\%TRIPLET%\include\ft2build.h"
set "FREETYPE_LIB_DEBUG=%PROJECT_ROOT%\vcpkg_installed\%TRIPLET%\debug\lib\freetyped.lib"
