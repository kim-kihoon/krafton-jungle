// Generated from C:/Users/jungle/Documents/Jungle_Week14_Team5/KraftonEngine/Content/Material/Custom/Helper.uasset
// Domain: Decal
...
{
    float2 n_46 = Input.UV0;
    float4 n_17 = Tex_Diffuse.Sample(LinearWrapSampler, n_46);
    float4 n_54 = Input.VertexColor;
    float3 n_49 = ((n_17).rgb * (n_54).rgb);
    float3 n_62 = (float4(n_49, 0.0f)).rgb;
    float3 n_67 = (float4(n_49, 0.0f)).rgb;
