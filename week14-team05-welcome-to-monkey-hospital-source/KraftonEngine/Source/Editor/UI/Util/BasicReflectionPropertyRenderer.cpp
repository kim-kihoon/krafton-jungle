...
namespace
{
	...
	bool RenderFixedCategoryTableBegin(const FString& TableId)
	{
		...
		Settings.ReflectionPropertyLabelColumnWidth = std::clamp(
			Settings.ReflectionPropertyLabelColumnWidth,
			MinPropertyLabelColumnWidth,
			MaxPropertyLabelColumnWidth);

		ImGui::TableSetupColumn("0", ImGuiTableColumnFlags_WidthFixed, Settings.ReflectionPropertyLabelColumnWidth);
